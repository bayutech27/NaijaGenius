...
export const CHALLENGES = [
  // === EASY (15) – reward 10–15 coins or one lifeline ===
  {
    ...
    rewardValue: 10,
    difficulty: "easy",
    condition: (stats) => stats.maxWinStreak >= 5 && stats.streakDirection === 'win'
  },
  {
    id: 1,
    title: "3 in a Row",
    ...
    rewardValue: 10,
    difficulty: "easy",
    condition: (stats) => stats.maxWinStreak >= 3 && stats.streakDirection === 'win'
  },
  {
    id: 2,
    title: "First Blood",
  ...
  },
  {
    ...
    rewardValue: 10,
    difficulty: "easy",
    condition: (stats) => stats.maxWinStreak >= 2 && stats.streakDirection === 'win'
  },
  {
    id: 4,
    title: "Steady Hands",
  ...
  },
  {
    ...
    rewardValue: 15,
    difficulty: "easy",
    condition: (stats) => stats.streakDirection === 'win' && stats.maxLossStreak >= 2
  },
  {
    id: 7,
    title: "Halfway There",
  ...
  },
  {
    ...
    rewardValue: 15,
    difficulty: "easy",
    condition: (stats) => stats.maxWinStreak >= 7 && stats.streakDirection === 'win'
  },
  {
    id: 9,
  ...
  },
  {
    ...
    rewardValue: 25,
    difficulty: "medium",
    condition: (stats) => stats.streakDirection === 'win' && stats.maxLossStreak >= 3
  },
  {
    id: 19,
    title: "Perfectionist",
  ...
  // === HARD (15) – reward 30 coins or one lifeline ===
  {
    ...
    rewardValue: 30,
    difficulty: "hard",
    condition: (stats) => stats.maxWinStreak === 10 && stats.streakDirection === 'win'
  },
  {
    id: 31,
    title: "Flawless Victory",
  ...
  },
  {
    ...
    rewardValue: 30,
    difficulty: "hard",
    condition: (stats) => stats.streakDirection === 'win' && stats.maxLossStreak >= 5
  },
  {
    id: 33,
  ...
  },
  {
    ...
    rewardValue: 30,
    difficulty: "hard",
    condition: (stats) => stats.streakDirection === 'win' && stats.maxLossStreak >= 4 && stats.correctCount >= 7
  },
  {
    id: 37,
    title: "The Loyalist",
  ...
  },
  {
    ...
    rewardValue: 30,
    difficulty: "hard",
    condition: (stats) => stats.maxWinStreak >= 8 && stats.streakDirection === 'win' && stats.correctCount === 10
  },
  {
    id: 41,
    title: "The Legend",
    ...
    rewardValue: 30,
    difficulty: "hard",
    condition: (stats) => stats.maxWinStreak === 10 && stats.streakDirection === 'win' && stats.lifelinesUsed === 0 && stats.totalTime < 25
  }
];
